...
def main():
    ...
    while running:
        ...
        #         pygame.draw.line(screen, (170, 74, 68), sprite.rect.center, (pipe_group.sprites()[closest_index].rect.left,pipe_group.sprites()[closest_index].rect.top ), 3)
        #         #draw line from bird to the bottom of top pipe
        #         pygame.draw.line(screen, (170, 74, 68), sprite.rect.center, (pipe_group.sprites()[closest_index + 1].rect.left,pipe_group.sprites()[closest_index + 1].rect.bottom ), 3)

        if len(pipe_group) > 0:
            #draw line from bird to the bottom of top pipe
            pygame.draw.line(screen, (170, 74, 68), (flappy.rect.center[0], flappy.rect.top), (pipe_group.sprites()[closest_pipe + 1].rect.left,pipe_group.sprites()[closest_pipe + 1].rect.bottom ), 3)
            # #draw line from bird to the bottom of top pipe
            # pygame.draw.line(screen, (170, 74, 68), (flappy.rect.center[0], flappy.rect.bottom), (pipe_group.sprites()[closest_pipe + 1].rect.left,pipe_group.sprites()[closest_pipe + 1].rect.bottom ), 3)
        ...
        for event in pygame.event.get():
            if event.type == QUIT:
                ...
                if event.key == pygame.K_SPACE and flappy.jump == False and flappy.gameOver == False:
                    # for sprite in bird_group:
                    #     sprite.flying = True
                    #     # sprite.jump = True
                    # flappy.jump = True
